...
const {checkNodeType} = require("./parseNode");
const {spacings, tightSpacings} = require("./spacingData");
const groupBuilders = require("./defineFunction")._htmlGroupBuilders;
const {DocumentFragment} = require("./tree");
const {Anchor} = require("./domTree");
...
const getTypeOfDomTree = function(
    node,
    side,
) {
    if (!node) {
...
module.exports = {buildExpression, getTypeOfDomTree, makeNullDelimiter, buildGroup, buildHTML}
