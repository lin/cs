// @flow
const {supportedCodepoint} = require("./unicodeScripts");
...
const metricMap = require("../submodules/katex-fonts/fontMetricsData");
...
module.exports = {setFontMetrics, getCharacterMetrics, getGlobalMetrics}
