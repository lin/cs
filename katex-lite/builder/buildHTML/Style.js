...
// we have 8 styles, user can use four of them
// 0, 2, 4, 6
// by cramp version, they are 1, 3, 5, 7
// for example:
// display.cramp will be 1
// display.sup will be 4
// display.sub will be 5
// display.fracNum will be 2
// display.fracDen will be 3
// display.text will be 1, same as display
module.exports = {
    DISPLAY:      styles[D],
    TEXT:         styles[T],
    SCRIPT:       styles[S],
